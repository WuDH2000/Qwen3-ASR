#!/bin/bash
#SBATCH --job-name=qwen3_asr_ta_eval
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
TRAIN_OUTPUT_DIR=${TRAIN_OUTPUT_DIR:-${PROJECT_DIR}/outputs/qwen3-asr-0.6b-tamil-sft}
CHECKPOINT_STEP=${CHECKPOINT_STEP:-}
TEST_JSONL=${TEST_JSONL:-/mnt/weka/aisg/speech_spoke/donghang/data/fleur/tamil/test.jsonl}
OUTPUT_DIR=${OUTPUT_DIR:-${PROJECT_DIR}/outputs/fleurs_tamil_eval}
...
"${PYTHON}" scripts/eval_qwen3_asr_fleurs_tamil.py \
