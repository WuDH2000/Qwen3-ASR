#!/bin/bash
#SBATCH --job-name=qwen3_asr_p4_sft_eval
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
TRAIN_OUTPUT_DIR=${TRAIN_OUTPUT_DIR:-${PROJECT_DIR}/outputs/qwen3-asr-0.6b-tamil-singlish-codeswitch-sft}
CHECKPOINT_STEP=${CHECKPOINT_STEP:-}
TEST_JSONL=${TEST_JSONL:-/mnt/weka/aisg/speech_spoke/donghang/data/meralion-multitask-national-speech-corpus-v1/test_part004.jsonl}
OUTPUT_DIR=${OUTPUT_DIR:-${PROJECT_DIR}/outputs/meralion_part4_eval_codeswitch_sft_0_6b}
