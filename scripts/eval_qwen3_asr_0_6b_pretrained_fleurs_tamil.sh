#!/bin/bash
#SBATCH --job-name=qwen3_asr_ta_base_eval
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
OUTPUT_DIR=${OUTPUT_DIR:-${PROJECT_DIR}/outputs/fleurs_tamil_eval_pretrained_0_6b}
...
echo "Python: ${PYTHON}"
echo "Pretrained model path: ${MODEL_PATH}"
