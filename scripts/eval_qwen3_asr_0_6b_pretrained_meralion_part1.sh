#!/bin/bash
#SBATCH --job-name=qwen3_asr_p1_base_eval
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
TEST_JSONL=${TEST_JSONL:-/mnt/weka/aisg/speech_spoke/donghang/data/meralion-multitask-national-speech-corpus-v1/test_part001.jsonl}
OUTPUT_DIR=${OUTPUT_DIR:-${PROJECT_DIR}/outputs/meralion_part1_eval_pretrained_0_6b}
