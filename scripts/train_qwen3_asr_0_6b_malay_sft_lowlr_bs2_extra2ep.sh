#!/bin/bash
#SBATCH --job-name=qwen3_asr_ms_sft_lowlr
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
MODEL_PATH=${MODEL_PATH:-${PROJECT_DIR}/outputs/qwen3-asr-0.6b-malay-sft/checkpoint-84}
...
OUTPUT_DIR=${OUTPUT_DIR:-${PROJECT_DIR}/outputs/qwen3-asr-0.6b-malay-sft-lowlr-bs2-extra2ep}
...
echo "Config: batch_size=${BATCH_SIZE:-2}, grad_acc=${GRAD_ACC:-8}, lr=${LR:-5e-6}, epochs=${EPOCHS:-2}"
nvidia-smi || true
