#!/bin/bash
#SBATCH --job-name=qwen3_asr_ms_lowlr_eval
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
TRAIN_OUTPUT_DIR=${TRAIN_OUTPUT_DIR:-${PROJECT_DIR}/outputs/qwen3-asr-0.6b-malay-sft-lowlr-bs2-extra2ep}
CHECKPOINT_STEP=${CHECKPOINT_STEP:-}
TEST_JSONL=${TEST_JSONL:-/mnt/weka/aisg/speech_spoke/donghang/data/fleur/malay/test.jsonl}
OUTPUT_DIR=${OUTPUT_DIR:-${PROJECT_DIR}/outputs/fleurs_malay_eval_finetuned_0_6b_lowlr_bs2_extra2ep}
