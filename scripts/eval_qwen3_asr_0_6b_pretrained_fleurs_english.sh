#!/bin/bash
#SBATCH --job-name=qwen3_asr_en_base_eval
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
TEST_JSONL=${TEST_JSONL:-/mnt/weka/aisg/speech_spoke/donghang/data/fleur/english/test.jsonl}
OUTPUT_DIR=${OUTPUT_DIR:-${PROJECT_DIR}/outputs/fleurs_english_eval_pretrained_0_6b}
